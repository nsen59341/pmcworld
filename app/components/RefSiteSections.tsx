...
function MastersSpeakSection() {
  ...
  return (
    <section className="relative mx-auto w-full overflow-hidden bg-white text-slate-900 py-20">
      ...
      <style>{`
        @keyframes masters-marquee {
          0% { transform: translateX(0); }
          100% { transform: translateX(-25%); }
        }
        .masters-scroll {
          animation: masters-marquee 120s linear infinite;
        }
        .group\\/marquee:hover .masters-scroll {
