    ...
    <nav className="fixed top-0 w-full bg-gray-800/95 backdrop-blur-sm z-40 border-b border-[#D4AF37]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Nav Items */}
          <div className="hidden md:flex gap-8 text-base font-semibold text-gray-300">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button className="px-5 py-2.5 bg-[#D4AF37] text-black font-bold rounded-full hover:bg-[#C49A2F] transition text-sm whitespace-nowrap">
              Be a Volunteer
            </button>
          </div>
